...
//
    ...
    RGraph.Meter = function (conf)
    {
        ...
        this.drawLabels = function ()
        {
            ...
            for (var i=0; i<=numLabels; ++i) {
                ...
                var coords = RGraph.getRadiusEndPoint(
                    ...
                    ((this.radius * 0.925) - (properties.textValign === 'bottom' ? 15 : 0) + properties.labelsRadiusOffset
                ));
        ...
        {
            if (properties.labelsValueText) {
                
                // The text label
                var text = (properties.labelsValueTextUnitsPre || '')
                            + (this.value).toFixed(properties.labelsValueTextDecimals)
                            + (properties.labelsValueTextUnitsPost || '');
                
                // Allow for a specific label
                if (typeof properties.labelsValueTextSpecific === 'string') {
                    text = properties.labelsValueTextSpecific;
                }
               ...
               italic: textConf.italic,
                    ...
                    halign:       'center',
                    valign:       'bottom',
                    bounding:     properties.labelsValueTextBackground,
                    boundingFill: properties.labelsValueTextBackgroundFill,
                    boundingStroke: properties.labelsValueTextBackgroundStroke,
                    accessible:     properties.labelsValueTextAccessible,
                    tag:            'value.text'
                });
            }
        };
